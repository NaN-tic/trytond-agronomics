...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-agronomics',
    download_url='https://github.com:nantic/trytond-agronomics.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-agronomics.git'
    },
    classifiers=[
